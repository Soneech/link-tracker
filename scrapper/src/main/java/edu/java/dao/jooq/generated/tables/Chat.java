...
import edu.java.dao.jooq.generated.DefaultSchema;
...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.REGISTERED_AT</code>.
     */
    public final TableField<ChatRecord, OffsetDateTime> REGISTERED_AT = createField(DSL.name("registered_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
